        ...
        <div className="">
          {productValue.map((item) => {
            ...
            return (
              <div
                key={id}
                className={`border-1 z-0 mb-2 flex animate-moveUp items-center justify-between gap-8 rounded-md border-lime-600 bg-lime-200 p-3 drop-shadow-md delay-[${setDelay}]`}
              >
