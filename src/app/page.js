      ...
      <div>
        <div className='bg-lime-200 py-12'>
          <header className='container grid grid-cols-homepageLayoutHero1 place-items-center gap-12 md:gap-16 lg:gap-20'>
            <div>
              <h2 className='capitalize text-4xl sm:text-5xl lg:text-7xl font-bold font-mono text-left text-lime-950'>shopping and department store</h2>
              <p className='text-sm sm:text-base md:text-base text-lime-800 py-4 text-left'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores eaque eligendi animi accusamus voluptatibus cupiditate consequuntur doloribus repudiandae adipisci temporibus?</p>
              <p className='text-sm sm:text-base md:text-base text-lime-800 pb-4 text-left'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit, voluptatem!</p>
              <div className=''>
